...
return cljs.core.assoc.call(null,G__21006,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__21006;
}
});
...
var len__4531__auto___21011 = arguments.length;
var i__4532__auto___21012 = (0);
while(true){
if((i__4532__auto___21012 < len__4531__auto___21011)){
args__4534__auto__.push((arguments[i__4532__auto___21012]));

var G__21013 = (i__4532__auto___21012 + (1));
i__4532__auto___21012 = G__21013;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq21008){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21009,G__21010,seq21008__$2);
});
...
var file = cljs.core.get.call(null,map__21015__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__21015__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__21015__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__21015,map__21015__$1,file,line,column){
return (function (p1__21014_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__21014_SHARP_));
});})(map__21015,map__21015__$1,file,line,column))
...
var temp__5457__auto___21019 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___21019)){
var message_21020 = temp__5457__auto___21019;
cljs.core.println.call(null,message_21020);
} else {
}
...
var output_dir__$1 = (function (){var G__21021 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__21021),"/"].join('');
} else {
return G__21021;
}
})();
...
var G__21023 = exception.stack;
var G__21023__$1 = (((G__21023 == null))?null:clojure.string.split_lines.call(null,G__21023));
var G__21023__$2 = (((G__21023__$1 == null))?null:cljs.core.get.call(null,G__21023__$1,depth));
if((G__21023__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__21023__$2);
}
} else {
...
var vec__21024 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__21024,(0),null);
var column = cljs.core.nth.call(null,vec__21024,(1),null);
var vec__21027 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__21027,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__21027,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__21027,(2),null);
...
var m__$1 = (function (){var G__21030 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__21034 = (function (){var G__21033 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__21033);
} else {
return G__21033;
}
})();
...
return cljs.core.vary_meta.call(null,G__21035,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
return cljs.core.map.call(null,(function (p__21042){
var vec__21043 = p__21042;
var ns = cljs.core.nth.call(null,vec__21043,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__21043,(1),null);
return ((function (vec__21043,ns,vars__$1){
return (function (){
...
var G__21046 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__21046,G__21046__$1,env,once_fixtures,each_fixtures,vec__21043,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__21046,G__21046__$1,env,once_fixtures,each_fixtures,vec__21043,ns,vars__$1){
return (function (){
var seq__21047 = cljs.core.seq.call(null,vars__$1);
var chunk__21048 = null;
var count__21049 = (0);
var i__21050 = (0);
while(true){
if((i__21050 < count__21049)){
var v = cljs.core._nth.call(null,chunk__21048,i__21050);
var temp__5457__auto___21052 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___21052)){
var t_21053 = temp__5457__auto___21052;
each_fixture_fn.call(null,((function (seq__21047,chunk__21048,count__21049,i__21050,t_21053,temp__5457__auto___21052,v,each_fixture_fn,G__21046,G__21046__$1,env,once_fixtures,each_fixtures,vec__21043,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_21053)));
});})(seq__21047,chunk__21048,count__21049,i__21050,t_21053,temp__5457__auto___21052,v,each_fixture_fn,G__21046,G__21046__$1,env,once_fixtures,each_fixtures,vec__21043,ns,vars__$1))
);
} else {
}


var G__21054 = seq__21047;
var G__21055 = chunk__21048;
var G__21056 = count__21049;
var G__21057 = (i__21050 + (1));
seq__21047 = G__21054;
chunk__21048 = G__21055;
count__21049 = G__21056;
i__21050 = G__21057;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__21047);
if(temp__5457__auto__){
var seq__21047__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__21047__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__21047__$1);
var G__21058 = cljs.core.chunk_rest.call(null,seq__21047__$1);
var G__21059 = c__4351__auto__;
var G__21060 = cljs.core.count.call(null,c__4351__auto__);
var G__21061 = (0);
seq__21047 = G__21058;
chunk__21048 = G__21059;
count__21049 = G__21060;
i__21050 = G__21061;
continue;
} else {
var v = cljs.core.first.call(null,seq__21047__$1);
var temp__5457__auto___21062__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___21062__$1)){
var t_21063 = temp__5457__auto___21062__$1;
each_fixture_fn.call(null,((function (seq__21047,chunk__21048,count__21049,i__21050,t_21063,temp__5457__auto___21062__$1,v,seq__21047__$1,temp__5457__auto__,each_fixture_fn,G__21046,G__21046__$1,env,once_fixtures,each_fixtures,vec__21043,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_21063)));
});})(seq__21047,chunk__21048,count__21049,i__21050,t_21063,temp__5457__auto___21062__$1,v,seq__21047__$1,temp__5457__auto__,each_fixture_fn,G__21046,G__21046__$1,env,once_fixtures,each_fixtures,vec__21043,ns,vars__$1))
);
} else {
}


var G__21064 = cljs.core.next.call(null,seq__21047__$1);
var G__21065 = null;
var G__21066 = (0);
var G__21067 = (0);
seq__21047 = G__21064;
chunk__21048 = G__21065;
count__21049 = G__21066;
i__21050 = G__21067;
continue;
}
} else {
...
});})(each_fixture_fn,G__21046,G__21046__$1,env,once_fixtures,each_fixtures,vec__21043,ns,vars__$1))
);
});})(each_fixture_fn,G__21046,G__21046__$1,env,once_fixtures,each_fixtures,vec__21043,ns,vars__$1))
], null);
