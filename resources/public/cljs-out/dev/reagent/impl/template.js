...
var G__21356 = o;
(G__21356[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__21360 = o;
(G__21360[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__21365 = props;
var G__21365__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__21365,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__21365);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__21365__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__21366){
...
var props = map__21367__$1;
var class$ = cljs.core.get.call(null,map__21367__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__21367,map__21367__$1,props,class$){
return (function (c){
...
});})(map__21367,map__21367__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__21369){
...
var on_write = cljs.core.get.call(null,map__21370__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__21370,map__21370__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__21370,map__21370__$1,on_write))
);
} else {
...
var G__21373 = jsprops;
(G__21373["defaultValue"] = value);

(G__21373["onChange"] = ((function (G__21373,v,value,on_change){
return (function (p1__21372_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__21372_SHARP_);
});})(G__21373,v,value,on_change))
);
...
var vec__21376 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__21376,(0),null);
var id = cljs.core.nth.call(null,vec__21376,(1),null);
var class$ = cljs.core.nth.call(null,vec__21376,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___21380 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___21380 == null)){
} else {
var key_21381 = temp__5461__auto___21380;
(jsprops["key"] = key_21381);
}
...
var temp__5461__auto___21382 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___21382 == null)){
} else {
var key_21383 = temp__5461__auto___21382;
reagent.impl.template.oset.call(null,jsprops,"key",key_21383);
}
...
var G__21384 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__21384["name"] = c);
...
var len__4531__auto___21389 = arguments.length;
var i__4532__auto___21390 = (0);
while(true){
if((i__4532__auto___21390 < len__4531__auto___21389)){
args__4534__auto__.push((arguments[i__4532__auto___21390]));

var G__21391 = (i__4532__auto___21390 + (1));
i__4532__auto___21390 = G__21391;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq21387){
var G__21388 = cljs.core.first.call(null,seq21387);
var seq21387__$1 = cljs.core.next.call(null,seq21387);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21388,seq21387__$1);
});
...
break;
default:
var G__21394 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__21394;
continue;
...
(a[i_21397] = reagent.impl.template.as_element.call(null,(a[i_21397])));

var G__21398 = (i_21397 + (1));
i_21397 = G__21398;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4408__auto___21399 = a.length;
var i_21400 = (0);
while(true){
if((i_21400 < n__4408__auto___21399)){
var val_21401 = (a[i_21400]);
if(((cljs.core.vector_QMARK_.call(null,val_21401)) && ((reagent.impl.template.key_from_vec.call(null,val_21401) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_21400] = reagent.impl.template.as_element.call(null,val_21401));

var G__21402 = (i_21400 + (1));
i_21400 = G__21402;
continue;
} else {
}
...
var ctx = ({});
var vec__21403 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__21403,(0),null);
var derefed = cljs.core.nth.call(null,vec__21403,(1),null);
...
var G__21406 = (cljs.core.count.call(null,argv) - first_child);
switch (G__21406) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__21406){
