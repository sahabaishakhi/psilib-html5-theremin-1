...
var o22992 = temp__5455__auto__;
var temp__5455__auto____$1 = (o22992["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o22993 = temp__5455__auto____$1;
return (o22993["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22104__auto__ = f;
return (o__22104__auto__["toString"]).call(o__22104__auto__);
} else {
return "";
}
}catch (e22994){var _ = e22994;
return "";
}});
...
try{var o__22104__auto___22996 = t;
(o__22104__auto___22996["cljs$lang$ctorPrWriter"]).call(o__22104__auto___22996,t,writer);
}catch (e22995){var __22997 = e22995;
}
...
var char_code = (function (){var o__22104__auto__ = (new String(char$));
return (o__22104__auto__["charCodeAt"]).call(o__22104__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22104__auto__ = String;
return (o__22104__auto__["fromCharCode"]).call(o__22104__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22998 = num_code;
switch (G__22998) {
case (1):
return (185);
...
var o__22104__auto__ = String;
return (o__22104__auto__["fromCharCode"]).call(o__22104__auto__,superscript_code);
});
/**
...
}catch (e23000){var _e__22111__auto__ = e23000;
return false;
}})())){
...
var vec__23001 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__23001,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o23004 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23004["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23005 = temp__5455__auto____$1;
return (o23005["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__23008){
var vec__23009 = p__23008;
var ns_detector = cljs.core.nth.call(null,vec__23009,(0),null);
...
var G__23015 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__23016 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__23015;
remaining_tokens = G__23016;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq23006){
...
var vec__23020 = cljs.core.split_with.call(null,(function (p1__23019_SHARP_){
return cljs.core.not_EQ_.call(null,p1__23019_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__23020,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__23020,(1),null);
...
var vec__23023 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__23023,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__23023,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__23026 = cljs.core.rest.call(null,remaining_tokens);
var G__23027 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__23026;
name_tokens = G__23027;
continue;
} else {
...
var vec__23030 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__23030,(0),null);
var arity = cljs.core.nth.call(null,vec__23030,(1),null);
var vec__23033 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__23033,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__23033,(1),null);
var vec__23036 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__23036,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__23036,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__23036,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__23036,(3),null);
...
var vec__23042 = result;
var munged_ns = cljs.core.nth.call(null,vec__23042,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__23042,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__23042,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__23042,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__23042,(4),null);
var arity = cljs.core.nth.call(null,vec__23042,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__23046 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__23046,(0),null);
var args = cljs.core.nth.call(null,vec__23046,(1),null);
var vec__23049 = devtools.munging.break_and_demunge_name.call(null,munged_name);
...
var G__23052 = (arity + (1));
var G__23053 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__23054){
var vec__23055 = p__23054;
var arity = cljs.core.nth.call(null,vec__23055,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__23055,(1),null);
...
return cljs.core.get.call(null,arities,p1__23058_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__23059_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__23062){
var vec__23063 = p__23062;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__23063,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq23060){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__23071__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__23071__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__23071__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__23071__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__23072 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__23072,(0),null);
var fn_name = cljs.core.nth.call(null,vec__23072,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__23072,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__23072,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__23072,(4),null);
var arity = cljs.core.nth.call(null,vec__23072,(5),null);
...
var o__22104__auto__ = f;
return (o__22104__auto__["getBasis"]).call(o__22104__auto__);
});
/**
...
}catch (e23076){var _e__22111__auto__ = e23076;
...
var G__23077 = (obj[cljs.core.first.call(null,path)]);
var G__23078 = cljs.core.rest.call(null,path);
obj = G__23077;
path = G__23078;
continue;
} else {
...
return (function (accum,p__23079){
var vec__23080 = p__23079;
var bit = cljs.core.nth.call(null,vec__23080,(0),null);
var protocol = cljs.core.nth.call(null,vec__23080,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__23083){
var vec__23084 = p__23083;
var ns = cljs.core.nth.call(null,vec__23084,(0),null);
var name = cljs.core.nth.call(null,vec__23084,(1),null);
var selector = cljs.core.nth.call(null,vec__23084,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__23089,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__23089,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__23089,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__23087_SHARP_){
return (obj[cljs.core.first.call(null,p1__23087_SHARP_)]);
});})(name,sorted_matches,vec__23089,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
